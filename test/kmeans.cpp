  ...
  // Pre-check
  {
    ...
    assert(std::size(results.clusters_indices) == 3);
    {
      bool condition =
          ...
          std::vector{static_cast<arma::uword>(1), static_cast<arma::uword>(5)};
      assert(condition);
    }
    {
      bool condition =
          results.clusters_indices[1] ==
          std::vector{static_cast<arma::uword>(0), static_cast<arma::uword>(2),
                      static_cast<arma::uword>(4), static_cast<arma::uword>(6),
                      static_cast<arma::uword>(7)};
      assert(condition);
    }
    {
