...
template <typename Window>
auto WindowsMergerWindowWeightsIterator<Window>::
...
template <typename Window>
auto
WindowsMergerWindowWeightsIterator<Window>::operator++() noexcept -> self& {
  ++weight_index;
  return *this;
}
...
template <typename Window>
auto
WindowsMergerWindowWeightsIterator<Window>::operator++(int) noexcept -> self {
  auto new_iter = *this;
  ++weight_index;
  return new_iter;
}
...
template <typename Window>
auto
WindowsMergerWindowWeightsIterator<Window>::
