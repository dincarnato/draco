...
template <typename> class RingmapMatrixColAccessor;
namespace detail {
template <typename> class RingmapMatrixColIteratorHelper;
}

template <typename Matrix> class RingmapMatrixColIterator {
