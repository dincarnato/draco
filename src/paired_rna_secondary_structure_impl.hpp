...
inline bool PairedBase::isPaired() const {
  return index != std::numeric_limits<std::size_t>::max();
}

inline std::size_t PairedBase::operator()() const { return index; }

inline bool PairedBase::operator<(const PairedBase &other) const {
...
inline bool PairedRnaSecondaryStructure::isPaired(std::size_t index) const {
...
inline auto PairedRnaSecondaryStructure::begin() const -> const_iterator {
  return std::begin(pairs);
}

inline auto PairedRnaSecondaryStructure::end() const -> const_iterator {
  return std::end(pairs);
}

inline const PairedBase &
PairedRnaSecondaryStructure::operator[](std::size_t index) const {
  return pairs[index];
}
...
inline auto PairedRnaSecondaryStructure::size() const -> size_type {
