...
struct WindowsMerger {
  ...
  inline static void process_queue(NaiveWindowsMerger &windows_merger) {
    windows_merger.process_queue();
  }

  inline static void prepare_cache(NaiveWindowsMerger &windows_merger) {
    windows_merger.prepare_cache();
  }

  inline static void prepare_indices(NaiveWindowsMerger &windows_merger) {
  ...
  inline static void prepare_distances(NaiveWindowsMerger &windows_merger) {
  ...
  inline static distance_type distance_between_bases(
  ...
  static inline void merge_cached_windows_into_first(
  ...
  static inline auto &dequeuing(NaiveWindowsMerger &windows_merger) {
  ...
  static inline auto &queue(NaiveWindowsMerger &windows_merger) {
    return windows_merger.queue;
  }

  static inline const auto &queue(const NaiveWindowsMerger &windows_merger) {
    return windows_merger.queue;
  }

  static inline auto &windows(NaiveWindowsMerger &windows_merger) {
    return windows_merger.windows;
  }

  static inline const auto &windows(const NaiveWindowsMerger &windows_merger) {
    return windows_merger.windows;
  }

  static inline auto &cache(NaiveWindowsMerger &windows_merger) {
    return windows_merger.cache;
  }

  static inline const auto &cache(const NaiveWindowsMerger &windows_merger) {
    return windows_merger.cache;
  }

  static inline auto &cache_indices(NaiveWindowsMerger &windows_merger) {
  ...
  static inline auto &windows_distances(NaiveWindowsMerger &windows_merger) {
