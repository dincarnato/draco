...
WindowsMergerWindowWeightsAccessor<
    Window>::WindowsMergerWindowWeightsAccessor(Window& window) noexcept
    : _window(&window) {}

template <typename Window>
auto
WindowsMergerWindowWeightsAccessor<Window>::size() const noexcept
    -> bases_size_type {
...
template <typename Window>
auto
WindowsMergerWindowWeightsAccessor<Window>::front() const noexcept
    -> reference {
...
template <typename Window>
auto
WindowsMergerWindowWeightsAccessor<Window>::back() const noexcept
    -> reference {
  assert(not _window->_bases.empty());
...
template <typename Window>
auto WindowsMergerWindowWeightsAccessor<Window>::
operator[](bases_size_type index) const noexcept -> reference {
...
template <typename Window>
auto
WindowsMergerWindowWeightsAccessor<Window>::begin() const noexcept
    -> iterator {
...
template <typename Window>
auto
WindowsMergerWindowWeightsAccessor<Window>::end() const noexcept -> iterator {
  return iterator(*_window, size());
}

template <typename Window>
auto
WindowsMergerWindowWeightsAccessor<Window>::rbegin() const noexcept
    -> reverse_iterator {
...
template <typename Window>
auto
WindowsMergerWindowWeightsAccessor<Window>::rend() const noexcept
    -> reverse_iterator {
