...
inline auto
WindowsMergerWindowBase::operator=(
    WindowsMergerWindowBaseAccessor<WindowsMergerWindows>&& rhs) noexcept(false)
    -> self& {
...
inline auto
WindowsMergerWindowBase::
operator=(WindowsMergerWindowBaseAccessor<WindowsMergerWindows&&>&&
              rhs) noexcept(false) -> self& {
  assign_from_accessor(std::move(rhs));
  return *this;
}
...
void
WindowsMergerWindowBase::assign_from_accessor(Accessor&& accessor) noexcept(
    false) {
...
inline auto
WindowsMergerWindowBase::weight(clusters_size_type index) noexcept
    -> weight_type& {
...
inline auto
WindowsMergerWindowBase::coverage() noexcept -> coverage_type& {
  return _coverage;
}
...
inline auto
WindowsMergerWindowBase::weights() const noexcept
