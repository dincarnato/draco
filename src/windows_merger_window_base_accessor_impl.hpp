...
template <typename Merger>
auto
WindowsMergerWindowBaseAccessor<Merger>::operator=(
...
template <typename Merger>
auto
WindowsMergerWindowBaseAccessor<Merger>::
operator=(WindowsMergerWindowBaseAccessor<WindowsMergerWindows>&& rhs) const
    noexcept(false) -> self const& {
...
auto
WindowsMergerWindowBaseAccessor<Merger>::
operator=(WindowsMergerWindowBase const& rhs) const noexcept(false)
    -> self const& {
...
auto
WindowsMergerWindowBaseAccessor<Merger>::
operator=(WindowsMergerWindowBase&& rhs) const noexcept(false) -> self const& {
...
template <typename Merger>
auto
WindowsMergerWindowBaseAccessor<Merger>::weight(clusters_size_type index) const
    noexcept -> weight_type& {
...
template <typename Merger>
auto
WindowsMergerWindowBaseAccessor<Merger>::coverage() const noexcept
    -> coverage_type& {
...
template <typename Merger>
auto
WindowsMergerWindowBaseAccessor<Merger>::clusters_size() const noexcept
    -> clusters_size_type {
...
template <typename Merger>
auto
WindowsMergerWindowBaseAccessor<Merger>::weights() const noexcept
...
template <typename Merger>
void
WindowsMergerWindowBaseAccessor<Merger>::perform_checks() const noexcept {
...
void
WindowsMergerWindowBaseAccessor<Merger>::assign_from_accessor(
...
void
WindowsMergerWindowBaseAccessor<Merger>::assign_from_base(Base&& rhs) const
    noexcept {
  perform_checks();
  assert(clusters_size() == rhs.clusters_size());
