...
struct RingmapData {
  ...
  static RingmapMatrix&
  m_data(::RingmapData& ringmap_data) noexcept {
    return ringmap_data.m_data;
  }
  ...
  static std::string&
  sequence(::RingmapData& ringmap_data) noexcept {
    return ringmap_data.sequence;
  }

  static unsigned&
  startIndex(::RingmapData& ringmap_data) noexcept {
    return ringmap_data.startIndex;
  }

  static unsigned
  startIndex(::RingmapData const& ringmap_data) noexcept {
    return ringmap_data.startIndex;
  }

  static unsigned&
  endIndex(::RingmapData& ringmap_data) noexcept {
    return ringmap_data.endIndex;
  }

  static unsigned
  endIndex(::RingmapData const& ringmap_data) noexcept {
    return ringmap_data.endIndex;
  }

  static unsigned&
  nSetReads(::RingmapData& ringmap_data) noexcept {
    return ringmap_data.nSetReads;
  }

  static unsigned
  nSetReads(::RingmapData const& ringmap_data) noexcept {
    return ringmap_data.nSetReads;
  }

  static unsigned&
  minimumCoverage(::RingmapData& ringmap_data) noexcept {
    return ringmap_data.minimumCoverage;
  }

  static unsigned
  minimumCoverage(::RingmapData const& ringmap_data) noexcept {
    return ringmap_data.minimumCoverage;
  }
  ...
  static float
  minimumModificationsPerBaseFraction(::RingmapData const& ringmap_data) noexcept {
