...
template <typename Matrix>
auto
RingmapMatrixColIterator<Matrix>::operator++() noexcept -> self& {
  ++col;
  return *this;
}
...
template <typename Matrix>
auto
RingmapMatrixColIterator<Matrix>::operator++(int) noexcept -> self {
  auto other = *this;
  ++col;
  return other;
}
...
template <typename Matrix>
auto
RingmapMatrixColIterator<Matrix>::operator+=(difference_type offset) noexcept
    -> self& {
  col += offset;
  return *this;
}
...
template <typename Matrix>
auto
RingmapMatrixColIterator<Matrix>::operator+(difference_type offset) const
    noexcept -> self {
...
template <typename Matrix>
auto
RingmapMatrixColIterator<Matrix>::operator-(self const& rhs) const noexcept
    -> difference_type {
...
bool
RingmapMatrixColIterator<Matrix>::
operator==(const RingmapMatrixColIterator& other) const noexcept {
...
template <typename Matrix>
auto RingmapMatrixColIterator<Matrix>::operator[](difference_type offset) const
    noexcept -> reference {
