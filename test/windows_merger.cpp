...
bool
operator==(typename WindowsMergerWindows::const_window_accessor merger_window,
...
bool
operator==(WindowsMergerWindows const& merger_windows,
...
static void
test_from_serialized_data(char const* filename) {
