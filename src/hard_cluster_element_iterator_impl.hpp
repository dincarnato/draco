...
template <typename Cluster, bool complemented>
auto
HardClusterElementIterator<Cluster, complemented>::operator++() noexcept
    -> self& {
  ++wrapper._element;
  return *this;
}
...
template <typename Cluster, bool complemented>
auto
HardClusterElementIterator<Cluster, complemented>::operator++(int) noexcept
    -> self {
  auto copy = *this;
  ++wrapper._element;
  return copy;
...
template <typename Cluster, bool complemented>
auto
HardClusterElementIterator<Cluster, complemented>::
...
auto
HardClusterElementIterator<Cluster, complemented>::
operator+(difference_type offset) const noexcept -> self {
  auto newIter = *this;
...
HardClusterElementIterator<_Cluster, _complemented>
operator+(
...
auto
HardClusterElementIterator<Cluster, complemented>::
operator-(const self& other) const noexcept -> difference_type {
  return wrapper._element - other.wrapper._element;
}

template <typename Cluster, bool complemented>
auto HardClusterElementIterator<Cluster, complemented>::operator*() const
    noexcept -> reference {
  return wrapper;
}

template <typename Cluster, bool complemented>
auto HardClusterElementIterator<Cluster, complemented>::
