...
template <typename Matrix>
auto RingmapMatrixRowIteratorHelper<Matrix>::begin() const noexcept
    -> iterator {
  return {*matrix, matrix->data.data()};
}

template <typename Matrix>
auto RingmapMatrixRowIteratorHelper<Matrix>::end() const noexcept -> iterator {
...
template <typename Matrix>
auto RingmapMatrixColIteratorHelper<Matrix>::begin() const noexcept
    -> iterator {
  return {*matrix, 0};
}

template <typename Matrix>
auto RingmapMatrixColIteratorHelper<Matrix>::end() const noexcept -> iterator {
