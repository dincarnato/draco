...
template <typename> struct WeightedClustersConcreteSpan;
template <typename> class WeightedClustersSpan;

template <typename T, bool useSpans = true> class WeightedClustersIterator {
