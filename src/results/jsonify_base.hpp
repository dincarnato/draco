...
template <typename T>
constexpr bool is_stringlike_v = is_stringlike<T>::value;
...
template <typename...>
struct false_var : std::false_type {};

template <typename... T>
constexpr bool false_var_v = false_var<T...>::value;
